...
struct AddWebsiteToListView: View {
    let listType: BlocklistMode
    ...
    var body: some View {
        VStack(spacing: DPWRKStyle.Layout.spacingLarge) {
            // Header
            HStack {
                Text("Add to \(listType.displayName)")
    ...
    private func validateURL(_ url: String) {
        ...
        // Basic validation - allow wildcards
...
#Preview {
    AddWebsiteToListView(listType: .blacklist) { _ in }
}